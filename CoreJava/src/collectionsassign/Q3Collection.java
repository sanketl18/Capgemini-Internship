...
public class Q3Collection {
	...
	public static void main(String[] args) {
		...
		Q3Collection q = new Q3Collection();
		q.select();
	}
	...
	private void select() {
		...
		if (a == 1) {
			...
			Employee e2 = new Employee(15, "anket", "ece", 85);
			Employee e3 = new Employee(12, "nket", "cse", 75);
			Employee e4 = new Employee(11, "ket", "eee", 95);
			t1.add(e1);
			t1.add(e2);
			t1.add(e3);
			t1.add(e4);
			...
			Employee1 e2 = new Employee1(15, "anket", "ece", 85);
			Employee1 e3 = new Employee1(12, "nket", "cse", 75);
			Employee1 e4 = new Employee1(11, "ket", "eee", 95);
			t2.add(e1);
			t2.add(e2);
			t2.add(e3);
			t2.add(e4);
			...
			Employee2 e2 = new Employee2(15, "anket", "ece", 85);
			Employee2 e3 = new Employee2(12, "nket", "cse", 75);
			Employee2 e4 = new Employee2(11, "ket", "eee", 95);
			t3.add(e1);
			t3.add(e2);
			t3.add(e3);
			t3.add(e4);
			...
			Employee3 e2 = new Employee3(15, "anket", "ece", 85);
			Employee3 e3 = new Employee3(12, "nket", "cse", 75);
			Employee3 e4 = new Employee3(11, "ket", "eee", 95);
			t4.add(e1);
			t4.add(e2);
			t4.add(e3);
			t4.add(e4);
